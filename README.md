...
|:--------:|:------------:|:------------:|  
| 待更 | 待更 | -- |
| 0.1.9 | 默认支持穿山甲:6.6.1.5，以下自行引入<br> 优量汇:`pod 'GDTMobSDK', '4.15.10.0'`<br> 百度:`pod 'BaiduMobAdSDK', '5.370.1'`<br>  快手:`pod 'KSAdSDK', '3.3.71.0'` | 2025年2月28日 |
| 0.1.7 | 默认支持穿山甲:6.4.1.0，以下自行引入<br> 优量汇:`pod 'GDTMobSDK', '4.15.0'`<br> 百度:`pod 'BaiduMobAdSDK', '5.370'`<br>  快手:`pod 'KSAdSDK', '3.3.67.0'` | 2024年11月18日 |  
| 0.1.6 | 默认支持穿山甲:6.4.1.0，以下自行引入<br> 优量汇:`pod 'GDTMobSDK', '4.15.0'`<br> 百度:`pod 'BaiduMobAdSDK', '5.370'`<br>  快手:`pod 'KSAdSDK', '3.3.67.0'` | 2024年9月12日 | 
# 集成错误若干解决方案
