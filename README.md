...
## 0.2.7（包括）版本之后不支持iOS12.0——功能异常。iOS13以上功能正常。

| 版本历史 | 支持平台 |  功能 | 更新时间 | 
|:--------:|:------------:|:------------:|:------------:|  
| 待更 | 待更 | -- |-- |
| 0.2.8 | 默认支持穿山甲:7.1.1.5 <br> 自行引入优量汇、百度、快手 <br> 优量汇:`pod 'GDTMobSDK', '4.15.60'`<br> 百度:`pod 'BaiduMobAdSDK', '10.02'`<br>  快手:`pod 'KSAdSDK', '4.9.20.1'` | 升级主sdk |2025年10月24日 |
