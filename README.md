...
|:--------:|:------------:|:------------:|:------------:|  
| 待更 | 待更 | -- |-- |
| 0.7.7.0.8 | 默认支持穿山甲:7.7.0.8 <br> 自行引入优量汇、百度、快手 <br> 优量汇:`pod 'GDTMobSDK', '4.15.90'`<br> 百度:`pod 'BaiduMobAdSDK', '10.050'`<br>  快手:`pod 'KSAdSDK', '5.5.10.1'` | 适配穿山甲最新版本 <br> SDK版本命名规则更改，与穿山甲保持一致|2026年9月1日 |
