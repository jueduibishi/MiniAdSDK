...
#define FFMPEG_CONFIGURATION "--target-os=darwin --arch=x86_64 --cc='xcrun -sdk iphonesimulator clang -DBORINGSSL_PREFIX=VOLC' --disable-shared --disable-symver --disable-doc --disable-ffplay --disable-ffmpeg --disable-ffprobe --disable-ffserver --disable-protocols --enable-fft --disable-rdft --enable-pthreads --disable-parsers --disable-demuxers --disable-muxers --disable-filters --disable-encoders --disable-decoders --disable-devices --disable-bsfs --enable-nonfree --enable-network --enable-swscale --enable-swresample --enable-avresample --enable-hwaccels --enable-decoder=h264 --enable-asm --disable-gpl --disable-version3 --disable-postproc --disable-libopencore_amrnb --disable-libopencore_amrnb --disable-libopencore_amrwb --disable-libvo_amrwbenc --disable-libxavs --disable-libmp3lame --disable-libxvid --enable-demuxer=flv --enable-demuxer=mov --enable-demuxer=hls --enable-protocol=hls --enable-protocol='tls*' --enable-protocol=http --enable-protocol=https --enable-protocol=httpproxy --enable-protocol=hlsproxy --enable-protocol=rtmp --enable-protocol=tcp --enable-filter=format --enable-filter=aformat --enable-filter=aresample --enable-filter=atempo --enable-filter=scale --disable-symver --enable-zlib --enable-stripping --enable-logging --disable-indevs --disable-outdevs --disable-version3 --enable-small --enable-optimizations --enable-debug --enable-openssl --enable-boringsslverify --disable-libfdk_aac --disable-libx264 --enable-drm --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=opus --enable-demuxer=aac --enable-demuxer=h264 --enable-demuxer=opus --enable-parser=aac --enable-demuxer=mpegts --enable-demuxer=mpegtsraw --enable-parser=aac_latm --disable-decoder=libbytevc2 --disable-asm --enable-pic --enable-cross-compile --extra-cflags='-arch x86_64 -mios-simulator-version-min=9.0 -fPIC -I/Applications/Xcode-15.1.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS17.2.sdk/usr/include/libxml2 -I/Users/VCloudiOS_1_4_ddkb_pwucm_nwlba/52815/ttffmpeg/ios/ttffmpeg/Pods/boringssl/include -I/Users/VCloudiOS_1_4_ddkb_pwucm_nwlba/52815/ttffmpeg/ios/ttffmpeg/Pods/boringssl/include/symbol_prefix_include -I/Users/VCloudiOS_1_4_ddkb_pwucm_nwlba/52815/ttffmpeg/ios/ttffmpeg/Pods/boringssl/boringssl.framework/Headers -I/Users/VCloudiOS_1_4_ddkb_pwucm_nwlba/52815/ttffmpeg/ios/ttffmpeg/Pods/boringssl/boringssl.framework/Headers/symbol_prefix_include' --extra-ldflags='-arch x86_64 -mios-simulator-version-min=9.0 -fPIC -lxml2 -L/Users/VCloudiOS_1_4_ddkb_pwucm_nwlba/52815/ttffmpeg/ios/ttffmpeg/Pods/boringssl -F/Users/VCloudiOS_1_4_ddkb_pwucm_nwlba/52815/ttffmpeg/ios/ttffmpeg/Pods/boringssl -F/Users/VCloudiOS_1_4_ddkb_pwucm_nwlba/52815/ttffmpeg/ios/ttffmpeg/Pods/boringssl/boringssl.xcframework/ios-i386_x86_64-simulator -F/Users/VCloudiOS_1_4_ddkb_pwucm_nwlba/52815/ttffmpeg/ios/ttffmpeg/Pods/boringssl/boringssl.xcframework/ios-arm64_x86_64-simulator' --prefix=/Users/VCloudiOS_1_4_ddkb_pwucm_nwlba/52815/ttffmpeg/ios/contrib/build/ffmpeg-x86_64"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2017
#define FFMPEG_DATADIR "/Users/VCloudiOS_1_4_ddkb_pwucm_nwlba/52815/ttffmpeg/ios/contrib/build/ffmpeg-x86_64/share/ffmpeg"
#define AVCONV_DATADIR "/Users/VCloudiOS_1_4_ddkb_pwucm_nwlba/52815/ttffmpeg/ios/contrib/build/ffmpeg-x86_64/share/ffmpeg"
...
#define CONFIG_BYTEVC2_MP4TOANNEXB_BSF 0
...
#define CONFIG_HTTPK_PROTOCOL 0
#define CONFIG_HTTPQ_PROTOCOL 0
...
#define CONFIG_RTMPK_PROTOCOL 0
#define CONFIG_RTMPQ_PROTOCOL 0
...
#define CONFIG_QUIC_PROTOCOL 0
#define CONFIG_REARQUIC_PROTOCOL 0
...
#define CONFIG_MEM_PROTOCOL 0
#define CONFIG_MDL_PROTOCOL 0
#define CONFIG_HLSPROXY_PROTOCOL 1
#define CONFIG_LIVE_PROTOCOL 0
#define CONFIG_HTTPX_PROTOCOL 0
#define CONFIG_THIRDPARTY_PROTOCOL 0
#define CONFIG_MEMORYDATASOURCE_PROTOCOL 0
